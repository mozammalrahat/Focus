...
const PostModelQA = require("../models/qa/PostModel");
const {
  newLikeNotification,
  removeLikeNotification,
} = require("../utilsServer/notificationActions");

const likeOrUnlikePostQA = async (postId, userId, like) => {
  try {
    const post = await PostModelQA.findById(postId);
...
module.exports = { likeOrUnlikePostQA };
